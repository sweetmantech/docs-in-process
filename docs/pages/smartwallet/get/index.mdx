...
| ----------------  | ------ | -------- | ------- | -----------------------------------------------------    |
| social_wallet     | string | Yes      | —       | The social wallet address to access a smart wallet       |
...
```bash [cURL]
curl -X GET "https://inprocess.fun/api/smartwallet?social_wallet=0x643D962630E35B49340C23079fBac7D8546d8D01"
```
