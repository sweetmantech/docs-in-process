...
```http
POST https://inprocess.fun/api/collection/uri
```
...
```bash [cURL]
curl -X POST https://inprocess.fun/api/collection/uri \
...
url = "https://inprocess.fun/api/collection/uri"
headers = {
...
const response = await fetch("https://inprocess.fun/api/collection/uri", {
  method: "POST",
  headers: {
    "Content-Type": "application/json",
    "x-api-key": "art_sk_3fnm4...f6w4",
