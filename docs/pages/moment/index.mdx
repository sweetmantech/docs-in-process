...
```json
{
  ...
  "tokenId": "string", // Token ID to re-index (usually "0")
...
| tokenId | string | Yes      | —       | The token ID of the Moment to index         |
...
```json
{
  ...
  "moment": {
    ...
    "updatedAt": "2025-06-07T21:00:12+00:00"
  }
}
````
