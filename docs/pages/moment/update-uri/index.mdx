...
This page documents the API endpoint for updating the URI (metadata) of an existing Moment on the In Process protocol. This endpoint allows artists to update the metadata URI associated with their Moment tokens.

> **Note:** Only the artist who has admin permission of the Moment can update its URI.
...
- The URI update is executed on-chain via a smart account transaction
- Only the artist who created the Moment can update its URI
