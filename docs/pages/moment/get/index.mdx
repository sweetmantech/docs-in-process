...
| -------------- | ------ | -------- | ---------------------------------------------- |
| tokenContract  | string | Yes      | The contract address of the Moment             |
| tokenId        | string | Yes      | The moment ID of the Moment                     |
| chainId        | string | Yes      | Chain ID where the contract lives              |
...
```json
{
    ...
    "momentAdmins": [
        "0x29b6674c1562e31EdFd9709D9576e8E5F1e68d01"
    ],
    "metadata": {
        "name": "My Moment",
        ...
        "content": {
            "mime": "audio/mpeg",
            "uri": "ar://U2PRZhy-S_Lrz_AMx-Qh2n6x8Lm3smO9SsLuno1DXRU"
        }
    }
}
```
