...
> **Note:** You must [create a Collection](/collections/create) first before creating a Writing Moment.
...
Send a JSON object with `contractAddress` to add a writing moment to an existing collection:
