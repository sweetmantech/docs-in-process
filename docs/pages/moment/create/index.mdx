...
> **Note:** If `splits` is provided, the `payoutRecipient` will be automatically set to the splits contract address. If `splits` is not provided, you can optionally specify a `payoutRecipient` directly.
