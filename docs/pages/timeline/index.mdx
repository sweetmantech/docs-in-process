...
```bash [cURL]
curl -X GET "https://inprocess.fun/api/timeline?artist=0x29b6674c1562e31EdFd9709D9576e8E5F1e68d01&chain_id=8453&limit=2&page=1&hidden=true"
```

```python [Python]
import requests

def get_timeline(address: str | None = None, collection: str | None = None, page: int = 1, limit: int = 100, chain_id: int = 8453, hidden: bool = False, type: str | None = None):
...
```bash [cURL]
curl -X GET "https://inprocess.fun/api/timeline?collection=0x06a701Ae65582B92Af48cDff45a8B20DcA3714cA&chain_id=8453&limit=2&page=1&hidden=true"
```

```python [Python]
import requests

def get_timeline(artist: str | None = None, collection: str | None = None, page: int = 1, limit: int = 100, chain_id: int = 8453, hidden: bool = False, type: str | None = None):
    url = "https://inprocess.fun/api/timeline"
    params = {"page": page, "limit": limit, "chain_id": chain_id}
    if artist:
