...
```
GET https://inprocess.world/api/artists/wallets
```
...
```bash [cURL]
curl -X GET "https://inprocess.world/api/artists/wallets?social_wallet=0x643D962630E35B49340C23079fBac7D8546d8D01"
```
...
const response = await fetch(
  `https://inprocess.world/api/artists/wallets?${params}`
);
