...
1. Navigate to the [In Process API Keys Management Site](https://inprocess.fun/manage/api-keys)
...
![API Keys Management Page](https://ibb.co/CsB2kvjw)
...
```bash
curl -X GET https://inprocess.fun/api/{endpoint} \
  -H "x-api-key: art_sk_3fnm4...f6w4" \
```

### Next Steps

With API key ready, we can now:
