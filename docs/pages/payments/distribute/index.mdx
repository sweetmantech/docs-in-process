...
| tokenAddress | string | No       | `0x0000000000000000000000000000000000000000` | The address of the token to distribute (optional, defaults to zero address for native token) |
