...
| tokenAddress | string | No       | `0x0...0` (zero address) | The address of the token to distribute (optional, defaults to zero address for native token) |
...
- `tokenAddress` is optional and defaults to the zero address (`0x0...0`) for native token distribution (ETH)
