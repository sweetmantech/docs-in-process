...
```http
GET https://inprocess.world/api/payments
```
...
```bash [cURL]
curl -X GET "https://inprocess.world/api/payments?artist=0x29b6674c1562e31EdFd9709D9576e8E5F1e68d01&collector=0x4b4324bcC6dB9380ABBbbD20B24A16C11FB5B38A"
```
...
async function getPayments(artist, collector) {
  ...
  const response = await fetch(
    `https://inprocess.world/api/payments?${params}`
  );
